...
//   }
  ...
  let root: RootType = (container._reactRootContainer: any);//container._reactRootContainer 不存在则首次渲染
  let fiberRoot;
  if (!root) {//首次不存在
    // Initial mount
    root = container._reactRootContainer = legacyCreateRootFromDOMContainer(
      container,
      forceHydrate,
    ); //获取new ReactDOMBlockingRoot
    fiberRoot = root._internalRoot; //得到FiberRootNode
