...
function timeoutForPriorityLevel(priorityLevel) {
  switch (priorityLevel) {
    case ImmediatePriority://立刻执行的任务
      return IMMEDIATE_PRIORITY_TIMEOUT;// -1
    case UserBlockingPriority: //交互任务
      return USER_BLOCKING_PRIORITY;// 250
    case IdlePriority://2^30-1 无过期
      return IDLE_PRIORITY;
    case LowPriority://10000
      return LOW_PRIORITY_TIMEOUT;
    case NormalPriority:
    default:
      return NORMAL_PRIORITY_TIMEOUT;//5000
  }
}
