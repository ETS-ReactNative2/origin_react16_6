...
function FiberRootNode(containerInfo, tag, hydrate) {
  ...
  this.pendingChildren = null;//用于持久化更新
  this.pingCache = null;
  this.finishedExpirationTime = NoWork;
  this.finishedWork = null;//完成的任务
  this.timeoutHandle = noTimeout;
  this.context = null;//不太常用
...
export function createFiberRoot(
  ...
  // stateNode is any.
  const uninitializedFiber = createHostRootFiber(tag);//创建一个初始化的FiberNode节点
